...
End Sub
Public Sub ShowText2(Msg As String) 'Sup To Tell Everything With ' To Goto txtOutput2
Const iMaxChar = 2500 'Maximum text scrollback
Dim iRemove As Integer
...
i = InStr(h + 1, Msg, Chr$(1))
frmMain.lblrankpoints.Caption = Mid$(Msg, h + 1, i - h - 1)
...
frmBuyDrugs.cmdForgetIt.SetFocus
DoEvents
