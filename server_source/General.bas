...
Public illegal As Boolean

'Maximum concurrent connections
Public Const MaxUsers = 30

'Anti-Hammer Boolean
Public RunCode(MaxUsers) As Boolean

'Global Heal Price
Public Const HealPrice = 1
...
'Decay Settings
Public Const DecayTime = 300000
Public DecayOld As Long
Public DecayNew As Long

'Player Heal
Public Const HealTime = 10000
Public HealNew As Long
Public HealOld As Long

'Player Adrenalin
Public Const AdrenalinTick = 1500

'The Skill Delay
    
Public Const SkillDelayTick = 2250
...
Public SYD_Location As Integer
Public UK_Location As Integer
...
Public Const SYD_Price = 456
Public Const UK_Price = 562
...
Public SYDMap As String
Public UKMap As String
...
'Reset Index Type Data For Fresh Login
   ...
   User(Index).Sniping = 0#
   User(Index).Searching = 0#
...
'Reset Index Type Data For Fresh Login
   ...
   UserDB(Index).Sniping = 0#
   UserDB(Index).Searching = 0#
   UserDB(Index).Chemistry = 0#
   UserDB(Index).Bounty = 0
...
Select Case a
   Case 1
    ...
    Case 8
      FemaleNames = "Rachel"
    Case 9
      FemaleNames = "Gretchen"
    Case 10
      FemaleNames = "Brooke"
    Case 11
      FemaleNames = "Courtney"
    Case 12
      FemaleNames = "Jessica"
    Case 13
      FemaleNames = "Maria"
    ...
    Case 23
      FemaleNames = "Kelly"
    Case 24
      FemaleNames = "Charlotte"
    Case 25
      FemaleNames = "Desire"
    Case 26
      FemaleNames = "Britney"
    Case 27
      FemaleNames = "Christina"
End Select
